...
// {87c65fb3-2696-462d-9473-fd87c7033e8d}
#define GUID_HW_CATENA_5120_BASE(f)		\
	MCCIADK_GUID_GEN_INIT(f,  0x87c65fb3, 0x2696, 0x462d, 0x94, 0x73, 0xfd, 0x87, 0xc7, 0x03, 0x3e, 0x8d)
